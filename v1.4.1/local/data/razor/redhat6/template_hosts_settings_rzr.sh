...
_rsc_rzr_nam="generic_compute64"
_rsc_rzr_des="Cyclops Razor Compute 64 GB specific Host General Settings Ctrl"  ## Use this script like family template for different types of hosts                                                                                  
_rsc_rzr_cmd=""                                                                          
_rsc_rzr_dae=""                                                                                                                     
_rsc_rzr_cfg=""                                                                             
